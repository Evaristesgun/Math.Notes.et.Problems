...
The question is adapted from Exercise 2 of \emph{Exponential Sums III: The van der Corput Method}, Harvard University Lecture Notes \cite{ElkiesVdC}.
\begin{theorem}
...
The question is adapted from Exercise 3 of \emph{Exponential Sums III: The van der Corput Method}, Harvard University Lecture Notes \cite{ElkiesVdC}.
\begin{theorem}
